    ...
    <section id="about" className="py-14 sm:py-18 md:py-20 relative z-10 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Zynova -Solutions is a digital technology brand focused on building modern software, websites, applications, automation systems, and data-driven business solutions."
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5">
            ...
            <p className="text-slate-300 leading-relaxed text-xs sm:text-sm">
              At Zynova -Solutions, we believe software must be resilient, beautiful, and directly tied to business results. We combine modern full-stack development, mobile engineering, AI workflows, and precision data analytics to solve tangible challenges.
            </p>
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {/* Machine Learning & AI Portfolio Showcase */}
                <div className="pt-2 space-y-2">
                  ...
                  >
                    ...
                    <div className="absolute top-2.5 left-3 pointer-events-none">
                      <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-amber-500/20 text-amber-300 border border-amber-400/30 backdrop-blur-sm flex items-center gap-1 font-semibold">
