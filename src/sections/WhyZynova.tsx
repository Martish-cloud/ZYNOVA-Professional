...
export const WhyZynova: React.FC = () => {
  ...
  return (
    <section id="why-zynova" className="py-24 sm:py-32 relative z-10 bg-transparent border-t border-amber-500/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          badge="WHY WORK WITH ZYNOVA"
          ...
          {reasons.map((r) => {
            ...
            return (
              <div
                ...
                className="group relative p-8 rounded-2xl bg-gradient-to-b from-slate-900/60 to-slate-950/80 border border-slate-800/80 hover:border-amber-400/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(245,158,11,0.2)] flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="p-3 rounded-xl bg-slate-800/80 border border-slate-700/60 group-hover:scale-110 group-hover:border-amber-500/40 transition-transform">
                      <Icon className={`w-5 h-5 ${r.iconColor}`} />
                    </div>
                  </div>

                  <h3 className="text-xl font-bold font-heading text-white mb-2 group-hover:text-amber-200 transition-colors">
                    {r.title}
                  </h3>

                  <div className="inline-block text-[11px] font-mono px-2 py-0.5 rounded bg-amber-500/10 text-amber-300 mb-4 border border-amber-500/30">
                    {r.highlight}
                  </div>
                ...
                <div className="pt-6 mt-6 border-t border-slate-800/60 flex items-center gap-2 text-[11px] font-mono text-slate-400">
