...
export const Footer: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: "Zynova Gives Back", href: "#gives-back" },
  ...
  return (
    <footer className="relative bg-transparent border-t border-slate-800/80 pt-12 sm:pt-14 pb-8 sm:pb-10 overflow-hidden text-slate-400">
      {/* Ambient glow accent */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            >
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-tr from-cyan-500 via-blue-600 to-purple-600 p-[1.5px]">
                <div className="w-full h-full bg-[#090b14] rounded-[6px] flex items-center justify-center">
                  <span className="font-heading font-black text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-xs sm:text-sm">
                    Z
                  </span>
                </div>
              </div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-sm leading-relaxed drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">
            ...
            <div className="pt-1.5 space-y-1.5 text-xs font-mono drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
              {/* Email */}
          ...
          {/* Column 2: Navigation */}
          <div>
            <h4 className="font-heading text-xs sm:text-sm font-semibold text-white uppercase tracking-wider mb-2.5 sm:mb-3 flex items-center gap-2 drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 mb-2.5 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
              Engage Zynova -Solutions securely via leading contract and freelance platforms:
            </p>
        ...
        {/* Bottom Bar */}
        <div className="pt-5 mt-5 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              onMouseLeave={resetCursor}
              className="p-1.5 sm:p-2 rounded-full bg-slate-900 border border-slate-700/70 hover:border-cyan-400 hover:text-cyan-300 text-slate-300 transition-all shadow-md cursor-pointer"
